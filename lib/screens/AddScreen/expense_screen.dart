...
import 'package:new_project/db/category/category_db.dart';
import 'package:new_project/db/transactions/transaction_db.dart';
import 'package:new_project/models/category/category_model.dart';
import 'package:new_project/models/transactions/transaction_model.dart';
import 'package:new_project/screens/Bottom_navigation_screen/bottom_navigation_scree.dart';
...
class _AddExpenseState extends State<AddExpense> {
  ...
  Future<void> addTransactions() async {
    ...
    TransactionDb.instance.addTransactions(expenseModel);
            ...
            showModalBottomSheet(
                ...
                builder: (context) {
                  return ValueListenableBuilder(
                      valueListenable:
                          CategoryDB().expenseeCategoryListNotifier,
